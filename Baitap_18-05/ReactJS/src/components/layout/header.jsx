            ...
            <div className="container mx-auto px-6 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    ...
                    >
                        ...
                        >
                            Categories <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`} />
                        </button>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
                            ...
                            <div>
                                <span className="text-xs font-bold text-gray-500 uppercase tracking-widest block mb-2">Categories</span>
