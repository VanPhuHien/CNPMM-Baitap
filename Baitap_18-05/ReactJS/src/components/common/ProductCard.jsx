    ...
    return (
        ...
        >
            ...
            <div className="relative aspect-square overflow-hidden rounded-t-2xl">
                ...
                {/* Quick Add Button */}
                <button className="absolute bottom-3 right-3 p-2.5 bg-primary text-dark rounded-xl opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 shadow-lg shadow-primary/20">
            ...
            <div className="p-4 flex flex-col flex-grow">
                ...
                <p className="text-xs text-gray-400 mb-4 line-clamp-2 flex-grow">
                    Premium quality and sleek design.
                </p>
