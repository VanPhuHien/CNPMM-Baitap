        ...
        <main className="pb-20 bg-dark min-h-screen">
            ...
            <section className="container mx-auto px-6 mt-24">
                ...
                {bestSellers.length > 0 ? (
                    ...
                    <p className="text-gray-500 italic">No best selling products found.</p>
                )}
            </section>
            ...
            <section className="container mx-auto px-6 mt-24">
                <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-3xl font-bold text-white tracking-tight">Most Viewed</h2>
                    </div>
                </div>
                {mostViewed.length > 0 ? (
                    <HorizontalProductSlider products={mostViewed} />
                ) : (
                    <p className="text-gray-500 italic">No highly viewed products found.</p>
                )}
            </section>
